                    ...
                    <div class="card-body ">
                        <form action="" method="get">
                            ...
                            <div class="d-flex align-items-center mb-3">
                                ...
                                <input type="email" name="correo" id="correo" class="form-control" value=" <?php recuerda('repContrasena') ?>">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="" method="get">
                            ...
                            <button type="registro" id="iniciarSesion" value="iniciarSesion" class="mt-3 btn btn-primary">Iniciar sesión</button>
                        </form>
                    </div>
                </div>
            </div>
