...
function verLibros(){
    try {
        ...
        foreach ($result as $valores) {
            ...
            echo "<button style='border: none; background: none; padding: 0;'><img src='https://upload.wikimedia.org/wikipedia/commons/thumb/f/f1/Heart_coraz%C3%B3n.svg/1200px-Heart_coraz%C3%B3n.svg.png' style='width:30px'></button><br><br>";
