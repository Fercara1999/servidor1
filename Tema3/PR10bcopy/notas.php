...
<body>
    ...
    if (isset($_GET['editar']))
        header("Location: ./anadeAlumno.php?alumno=" . $_REQUEST['dato0'] . "&nota1=" . $_REQUEST['dato1'] . "&nota2=" . $_REQUEST['dato2'] . "&nota3=" . $_REQUEST['dato3']."&accion=editar");

    if (isset($_GET['eliminar'])) 
        header("Location: ./eliminar.php?alumno=" . $_REQUEST['dato0'] . "&nota1=" . $_REQUEST['dato1'] . "&nota2=" . $_REQUEST['dato2'] . "&nota3=" . $_REQUEST['dato3']);
    
    if (isset($_GET['anade']))
        header("Location: ./anadeAlumno.php?accion=anade");
